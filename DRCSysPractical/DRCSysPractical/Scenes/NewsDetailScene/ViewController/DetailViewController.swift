...
final class DetailViewController: BaseViewController {
    ...
    private func setupUI() {
        self.lblSongTitle.text = self.viewModel.selectedNews!.value(forKeyPath: "title") as? String
        let strImageURL = self.viewModel.selectedNews!.value(forKeyPath: "image") as? String ?? ""
        self.imageNews.downloaded(from: strImageURL)
        let strAudioURL = self.viewModel.selectedNews!.value(forKeyPath: "link") as? String ?? ""
